...
<div class="card-grid">
  ...
  <div class="item-card" style='margin-bottom: 20px;'>
    <div class="item-card-image" style='height: 100%'>
      <img src="/img/proj_1.png" alt="Diagram of multi-scale heterogeneous networks">
    </div>
    <div class="item-card-content">
      <h3>New Methods for Drug Repositioning via Multi-Scale Heterogeneous Networks</h3>
  ...
  <div class="item-card" style='margin-bottom: 20px;'>
    <div class="item-card-image" style='height: 100%'>
      <img src="/img/proj_2.png" alt="Diagram of drug repurposing">
    </div>
    <div class="item-card-content">
      <h3>Screening Candidate Drugs for Breast Cancer via Drug Repurposing</h3>
  ...
  <div class="item-card" style='margin-bottom: 20px;'>
    <div class="item-card-image" style='height: 100%'>
      <img src="/img/proj_3.png" alt="Diagram of multi-omics data integration">
    </div>
    <div class="item-card-content">
      <h3>Drug Repositioning for Non-Small Cell Lung Cancer Based on Multi-Omics Integration</h3>
  ...
  <div class="item-card" style='margin-bottom: 20px;'>
    <div class="item-card-image" style='height: 100%'>
      <img src="/img/proj_4.png" alt="Diagram of heterogeneous network embedding">
    </div>
    <div class="item-card-content">
      <h3>Drug Repositioning for Esophageal Cancer Based on Network Embedding</h3>
  ...
  <div class="item-card" style='margin-bottom: 20px;'>
    <div class="item-card-image">
      <img src="/img/proj_5.png" alt="Diagram of multi-scale network embedding">
    </div>
    <div class="item-card-content" style='height: 100%'>
      <h3>Drug Repositioning for NSCLC via Multi-Scale Network Embedding</h3>
